...
import PdfCard from 'src/PDFGenerator/PDFCardArticlesSales';
...
export function ProdajaArtikalaView() {
  ...
  useEffect(() => {
   if(prodajaArtikala!==null){
    setFetchedData(prodajaArtikala.Items);
   }
  }, [prodajaArtikala]);
  ...
  return (
    <DashboardContent>
      ...
      <Box sx={{position: 'relative', left: '700px', bottom: '170px'}}>
        <PdfCard title='Prodaja artikala'/>
      </Box>
            ...
            <Table stickyHeader sx={{ minWidth: 800 }}>
              ...
              <TableBody>
                {paginatedData && paginatedData.length > 0 ? (
                  paginatedData.map((item: Items, index: any) => (
                    <TableRow key={index}>
