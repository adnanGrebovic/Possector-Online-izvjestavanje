...
import PdfCard from 'src/PDFGenerator/PDFCardPaymentType';
...
export function VrstePlacanjaView() {
  ...
  useEffect(()=>{
    if(vrstePlacanja!==null){
      setFetchedData(vrstePlacanja.Items);
    }
  }, [vrstePlacanja])
